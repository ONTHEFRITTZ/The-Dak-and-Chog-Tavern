...
/// @title PokerTablePool - Cash-game table with pooled custody (BankrollPool)
/// @notice All deposits are forwarded to the shared pool. This contract tracks per-seat balances
///         and uses the pool to pay withdrawals. Hand lifecycle is owner-orchestrated for off-chain play engines.
contract PokerTablePool {
