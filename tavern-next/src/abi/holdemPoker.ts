export const HoldemPokerABI = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "sb", type: "uint256" },
      { internalType: "uint256", name: "bb", type: "uint256" },
    ],
    name: "setBlinds",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "bool", name: "duringHand", type: "bool" },
    ],
    name: "forceUnseat",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  {
    inputs: [{ internalType: "uint8", name: "seatId", type: "uint8" }],
    name: "joinSeat",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  },
  {
    ...
    name: "seats",
    outputs: [{ internalType: "address", name: "player", type: "address" }],
    stateMutability: "view",
    type: "function",
  },
  {
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, internalType: "uint256", name: "sb", type: "uint256" },
      { indexed: false, internalType: "uint256", name: "bb", type: "uint256" },
    ],
    name: "BlindsUpdated",
    type: "event",
  },
...
export type HoldemPokerABIType = typeof HoldemPokerABI;
