...
// Pre-deployed MetaMask Delegation Toolkit (DeleGator) addresses for Monad Testnet (chain id 10143).
// Ported from the legacy public/js assets so the Next.js runtime can consume them directly.

export const MONAD_DELEGATION_VERSION = "1.3.0";

export const MONAD_DELEGATION_ENV = {
...
export type DelegationEnvironment = typeof MONAD_DELEGATION_ENV;
