...
const CONFIG = {
  ...
  paymasterTopUpChunk: parseEther(process.env.DCMON_PAYMASTER_CHUNK || '0'),
  ...
  poolDcmonMin: parseEther(process.env.DCMON_POOL_MIN_DCMON || '0'),
  poolDcmonTarget: parseEther(process.env.DCMON_POOL_TARGET_DCMON || '0'),
  poolUnderlyingMin: parseEther(process.env.DCMON_POOL_MIN_UNDERLYING || '0'),
  poolUnderlyingTarget: parseEther(process.env.DCMON_POOL_TARGET_UNDERLYING || '0'),
  wrapMaxChunk: parseEther(process.env.DCMON_WRAP_MAX_CHUNK || '0'),
  operatorNativeReserve: parseEther(process.env.DCMON_OPERATOR_KEEP_NATIVE || '0.05'),
