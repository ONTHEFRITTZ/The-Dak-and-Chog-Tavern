...
/// @title Shell - DCmon-native shell game with pooled payouts
contract Shell {
    ...
    /// @param guess 0..2 (cup index), wager in DCmon units
    function playShell(uint8 guess, uint256 wager) external nonReentrant {
