...
import {
  ...
  ALCHEMY_PAYMASTER_RPC as ROOT_ALCHEMY_PAYMASTER_RPC,
  ALCHEMY_API_KEY as ROOT_ALCHEMY_API_KEY,
  ALCHEMY_POLICY_ID as ROOT_ALCHEMY_POLICY_ID,
  PAYMASTER_ADDRESS as ROOT_PAYMASTER_ADDRESS,
...
export const ALCHEMY_PAYMASTER_RPC = ROOT_ALCHEMY_PAYMASTER_RPC;
export const ALCHEMY_API_KEY = ROOT_ALCHEMY_API_KEY;
export const PAYMASTER_ADDRESS = ROOT_PAYMASTER_ADDRESS;
export const ALCHEMY_POLICY_ID = ROOT_ALCHEMY_POLICY_ID;
